...
.background-3X6N7I path {
  fill: var(--darkplus-bg);
}
...
.iconWrapper-2awDjA[aria-label="Ukryj listę członków"]{
  display: none;
}
.show-sessions-logs{
  display: none;
...
#user-context-timeout .label-22pbtT{
  color: rgb(185, 0, 0)
}
#user-context-kick .label-22pbtT{
  color: rgb(185, 0, 0)
}
#user-context-ban .label-22pbtT{
  color: rgb(185, 0, 0)
}
